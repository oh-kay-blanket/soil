      ...
      if (isHoverDevice()) {
        google.maps.event.addListener(marker, "mouseover", function () {
          ...
          tooltipWindow.setContent(
            `<div class="marker-tooltip">${marker.cityName}${marker.year ? `<div class="marker-tooltip__year">${marker.year}</div>` : ""}</div>`,
          );
